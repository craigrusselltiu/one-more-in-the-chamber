...
export const TILE_DEFINITIONS: Record<TileType, TileDefinition> = {
  ...
  buckshot: {
    ...
    upgradeValue: 2,
    pool: 'starter',
    description: 'Deal 1 damage to a random enemy per tile.',
  ...
  whiskey: {
    ...
    upgradeValue: 1,
    pool: 'additional',
    description: 'Heals 1 HP per 3-match; +1 per extra tile.',
  ...
  saloon: {
    ...
    upgradeValue: 1,
    pool: 'additional',
    description: 'Heal 1 HP per 3-match; +1 per extra tile. Generate the resources of adjacent tiles.',
